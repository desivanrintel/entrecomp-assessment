    ...
    try {
      const response = await fetch(`${API_URL}/api/change-password`, {
        ...
        body: JSON.stringify({
          ...
          confirm_new_password: confirmPassword, // Send to backend
        }),
      });
      ...
      <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <form onSubmit={handlePasswordChange} className="space-y-6">
          ...
          <button
            ...
            className="w-full py-3 bg-gray-900 text-white rounded-xl font-bold hover:bg-gray-800 transition disabled:opacity-50"
          >
